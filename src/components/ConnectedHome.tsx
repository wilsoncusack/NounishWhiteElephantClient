...
export function ConnectedHome() {
    ...
    return(
        <div>
            ...
            <p> See them on <a href="https://opensea.io/collection/nounish-white-elephant-christmas">OpenSea.</a></p>
            ...
            <iframe  src="https://www.youtube.com/embed/RnDg0wdwkF8" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </div>
    )
}